...
<template>
  <div class="builder-container">
    ...
    <div v-if="currentSubject" class="bg-black/20 p-2 rounded-b-md">
      ...
      >
        <IdentityForm v-model="currentSubject.subject" />
      </Section>
      ...
      <Section
        ...
        @toggle="toggle('face')"
      >
        <FaceForm v-model="currentSubject.face" />
      </Section>
      ...
      <Section
        ...
        @toggle="toggle('hair')"
      >
        <HairForm :modelValue="currentSubject.hair" />
      </Section>
      ...
      >
        <OutfitForm v-model="currentSubject.outfit" />
      </Section>
      ...
      <Section
        ...
        @toggle="toggle('pose')"
      >
        <PoseForm v-model="currentSubject.pose" />
      </Section>
    </div>
